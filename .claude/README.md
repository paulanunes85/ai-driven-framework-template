...
|-------|-----------|---------|-------|
| **Agents** | `agents/` | Subagents with specific model assignments that handle specialized tasks | 4 |
...
2. It delegates to a specialized **subagent** (Content Analyst, Engagement Builder, or Markdown Writer)
...
|-------------|----------------|-------|
| `agents/` | `agents/` | Same 4 agents; Claude uses model assignments, Copilot uses tool lists |
